#
#  Be sure to run `pod spec lint EWCacheManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.author             = { "Electric Wizardry, LLC" => "" }
  # Or just: s.author    = "Electric Wizardry, LLC"
  s.authors            = "Electric Wizardry, LLC", "Eric Bailey"
  # s.social_media_url   = "http://twitter.com/Electric Wizardry, LLC"
  ...
  s.source       = { :git => "https://github.com/ElectricWizardry/EWCacheManager.git", :tag => "v1.3" }
